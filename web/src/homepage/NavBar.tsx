...
const NavBar = () => {
  return (
    <div className="grid place-items-center px-12 py-5 rounded-b-xl md:place-items-stretch md:grid-cols-2 md:px-32 bg-gunmetal2 bg-opacity-75">
      ...
      <div className="right-nav hidden md:flex flex-row-reverse items-center space-x-12 space-x-reverse">
        ...
        <Link to="/login/user">
          <button className="font-semibold right-3">
            Iniciar sesion
          </button>
        </Link>
      </div>
